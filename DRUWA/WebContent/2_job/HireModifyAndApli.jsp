...
<%@page import="apli.model.ApliName"%>
<%@ page import="company.model.Company"%>
<%
	Hire hire = (Hire) request.getAttribute("resultSingleHire");
	List<ApliName> apliNameList = (List<ApliName>) request.getAttribute("resultApliList");
      ...
      <div id="page" class="container">
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th>등록날짜</th>
                  <td>
                    <input type="text" value="<%=hire.getStrDate()%>" readOnly />
                  </td>
                </tr>
              </thead>
              ...
              <tbody>
                <tr>
                  <th>공고명</th>
                  <td colspan="3">
                    <input type="text" name="hireTitle" value="<%=hire.getHireTitle()%>" required />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <th>채용인원</th>
                  <td>
                    <input type="text" name="hireMan" value="<%=hire.getHireMan()%>" required />
                  </td>
                </tr>
                ...
                <tr>
                  <th>마감날짜</th>
                  <td>
                    <input type="text" name="expDate" value="<%=hire.getExpDate()%>" />
                  </td>
                  <td></td>
                  <td>
        ...
        <section>
          ...
          <div class="table-wrapper">
            ...
            <!--             <form name="frmApli" action="/DRUWA/HireControl?cmd=insert-save" method="post"> -->
            <table>
              <thead>
                <tr>
                  <th>이름</th>
              ...
              <tbody class="research">
                ...
                <%
                  	for (int i = 0; i < apliNameList.size(); i++) {
                  %>

                <tr class="trheader">
                  <td><%=apliNameList.get(i).getName()%></td>
                  <!--이름-->
                  <td><%=apliNameList.get(i).getTel()%></td>
                  <!--연락처-->
                  <td><%=apliNameList.get(i).getLang()%></td>
                  <!--가능언어-->
                  <td><%=apliNameList.get(i).getApliDate()%></td>
                  <!--지원날짜-->
                  <td><a href="/DRUWA/MemberControl?cmd=please-login-page=<%=apliNameList.get(i).getResume()%>" class="button alt icon fa-download"> 이력서 다운로드</a></td>
                  <!--이력서-->
                </tr>
                <%
                  	}

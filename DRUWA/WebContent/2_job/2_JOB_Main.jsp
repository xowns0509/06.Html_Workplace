  ...
  <div id="wrapper">
	...
	padding-left: 20px;">
        ...
        <section>
          ...
          <div class="row 50% uniform">
            ...
            <div class="3u view view-first">
              ...
              <p>
                ...
                %>
                <a href="/DRUWA/ff.tj?cmd=company-list-page&companyId=<%=ary.get(i).get(j).getCompanyId()%>" class="enter" style="font-size: 17px;"><%=j + 1%>위:<%=" " + ary.get(i).get(j).getHireTitle()%> </a>
                <br />
          ...
          <div>*마우스를 살짝 올리시면 해당 분야의 인기 공고를 확인 하실 수 있어요~</div>

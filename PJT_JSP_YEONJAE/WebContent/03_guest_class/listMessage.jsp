...
<body>
	...
	<table border="1">
		...
		<tr>
			...
			<td><a href="deleteMessage.jsp?id=<%= m.getId() %>">[삭제하기]</a></td>
		</tr>
		<tr>
			<td colspan='3'><textarea cols=35 rows=3
					style="font-family: '돋움', '돋움체'; font-size: 10pt; font-style: normal; line-height: normal; color: #000; background-color: #70c1b3; border: 1 solid #00009C;"><%= m.getMessage() %></textarea>
			</td>
		</tr>
		<% } %>
	</table>
	...
	<a href="listMessage.jsp?page=<%=nextPage%>">[▷]</a>
	<a href="listMessage.jsp?page=<%=totalPageCount%>">[▶]</a>
